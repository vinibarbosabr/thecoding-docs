...
- [x] Phase 7 — Chrome & consistency: shared CTAs, metadata, links, create `llms.txt`, verify redirects, mobile nav QA, full QA click-through *(issue #13)*
- [x] Phase 8 — Revision & ship: revision pass against the brief, release to `main`, handoff note *(issue #15, PR #14)*
